...
export interface IFabricRuntimeConnection extends IFabricConnection {

    initialize(): Promise<void>;

    getOrganizations(): Set<string>;

    getCertificateAuthorityNames(): Array<string>;
    ...
    register(certificateAuthrityName: string, enrollmentID: string, affiliation: string): Promise<string>;
}
